...
const FileUpload: React.FC<FileUploadProps> = ({
  ...
  return <Box sx={{
    ...
    mb: 1
      ...
      {!file ? <Button variant="outlined" component="label" fullWidth startIcon={<CloudUpload />} disabled={disabled}>
          Upload File (PDF/Image, Max 10MB)
          <input type="file" hidden accept=".pdf,image/*" onChange={handleFileSelect} disabled={disabled} />
        </Button> : <Box sx={{
      display: "flex",
      alignItems: "center",
      p: 2,
