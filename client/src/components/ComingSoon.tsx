...
export const RocketAnimation: React.FC = () => (
  ...
  >
    <svg width="120" height="150" viewBox="0 0 120 150">
      {/* Main Rocket Group with float animation */}
      <g
        style={{
      ...
      <g opacity="0.4">
        <circle
          ...
          r="4"
          fill="#9ca3af"
          sx={{ animation: `${smokeUp} 3s ease-out infinite` }}
        />
        <circle
          cx="60"
          cy="105"
          r="3"
          fill="#9ca3af"
          sx={{ animation: `${smokeUp} 3s ease-out infinite 0.5s` }}
        />
        <circle
          cx="65"
          cy="100"
          r="3.5"
          fill="#9ca3af"
          sx={{ animation: `${smokeUp} 3s ease-out infinite 1s` }}
        />
        <circle
          cx="58"
          cy="110"
          r="2.5"
          fill="#9ca3af"
          sx={{ animation: `${smokeUp} 3s ease-out infinite 1.5s` }}
        />
        <circle
          cx="62"
          cy="108"
          r="2"
          fill="#9ca3af"
          sx={{ animation: `${smokeUp} 3s ease-out infinite 2s` }}
        />
      </g>
